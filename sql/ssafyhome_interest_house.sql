...
CREATE TABLE `interest_house` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKkupkqethp6rid6u24kene7krr` (`apt_seq`),
  KEY `FK9uudamk3heyu1n8kpam6qv6ao` (`user_id`),
  CONSTRAINT `FK9uudamk3heyu1n8kpam6qv6ao` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FKkupkqethp6rid6u24kene7krr` FOREIGN KEY (`apt_seq`) REFERENCES `apartment` (`apt_seq`)
